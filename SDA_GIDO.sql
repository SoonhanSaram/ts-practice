...
upper_menu varchar(20) comment '상위 메뉴id',
...
insert into GIDO_menu_info value('ad01', '푸시알람', 1 ,'', '', 'y', 'admin');
insert into GIDO_menu_info value('ad02', '회원관리', 2 ,'' , '', 'y', 'admin');
insert into GIDO_menu_info value('ad03', '배너관리', 3,'' , '', 'y', 'admin');
insert into GIDO_menu_info value('ad04', '메뉴관리', 4,'' , '', 'y', 'admin');

insert into GIDO_menu_info value('ad0301', '이벤트배너관리',1 ,'ad03' , '', 'y', 'admin');
insert into GIDO_menu_info value('ad0302', '팝업관리', 2,'ad03' , '', 'y', 'admin');
